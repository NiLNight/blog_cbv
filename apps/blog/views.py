...
def tr_handler404(request, exception):
    ...
    """
    return render(request=request, template_name='errors/error_page.html',
                  status=404,
                  context={
...
def tr_handler500(request):
    ...
    return render(request=request, template_name='errors/error_page.html',
                  ...
                  context={
                      ...
                      'error_message': 'Внутренняя ошибка сайта, вернитесь на главную страницу, отчёт об ошибке мы'
                                       ' направим администрации сайта',
                  })
